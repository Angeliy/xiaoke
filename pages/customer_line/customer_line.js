...
Page({
  ...
  getwayprocet: function () {
    ...
    comm.requestPost("/service/customer/viewMyOrder.do", data, function (res) {
      console.log(res);
      if (res.data.result == 200 && typeof res.data.data.list != "undefined") {
        var list = res.data.data.list;
        for (var i in list) {
          var projects = list[i].projectList;
          var projectName = "";
  ...
  openConfirm: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          comm.requestPost("/service/customer/cancelOrder.do", data, function (res) {
